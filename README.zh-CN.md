# 开源aibesttop AI Web UI

这是一个由[aibesttop AI工具导航站](https://aibesttop.com)开源的AI导航站项目。我们的目标是让大家很容易就拥有一个属于自己的AI导航站，
收录自己喜欢的AI工具产品。这个项目非常轻量级，维护简单，适合对AI导航站感兴趣的个人开发者，也适合对NextJs有兴趣的学习者，
欢迎大家fork和star。

[English](https://github.com/6677-ai/aibesttop-ai-webui/blob/main/README.md) | 简体中文

## 请在Product Hunt支持下aibesttop AI
...
- 对接aibesttop AI爬虫项目，支持提交和收录全自动
- 支持简易的分类和搜索

注：如果你对数据库不熟悉，或者担心和v1.0.0版本的兼容问题，请点击切
到[v1.0.0分支](https://github.com/6677-ai/aibesttop-ai-webui/tree/v1.0.0)。
...
![tai4-ai](./public/images/aibesttopai.zh-CN.png)

## 感谢关注链接

欢迎关注我们的Twitter: https://x.com/aibesttopai
...
如果你对项目有兴趣，欢迎添加我微信: helloleo2023, 备注: "aibesttop ai开源"，也可以扫描二维码:
![aibesttop-ai-wx](./public/images/aibesttop-ai-wechat.jpg)

## 部署说明

### 部署aibesttop AI Crawler

具体见[aibesttop AI Crawler](https://github.com/6677-ai/aibesttop-ai-crawler) 部署完成后，可以使用平台提供的域名或者自定义域名，作
...
可以通过aibesttop AI开源的来自其他导航站的13000+个AI工具列表导入(支持sql和csv)：
[AI Source List](https://github.com/6677-ai/aibesttop-ai-webui/blob/main/ai_source_list)

## 打算在 aibesttop.com 上提交您的网站？

请打开：[aibesttop AI](https://aibesttop.com/submit)

### 打算将您的网站添加到我们的 `/startup` 页面？

- 在这里打开一个问题：[aibesttop-AI-Directory](https://github.com/6677-ai/aibesttop-AI-Directory/issues)
- 给我们发邮件：[contact@aibesttop.com](mailto:contact@aibesttop.com)
...
问：[aibesttop AI](https://aibesttop.com)

### 如何在网站列表中获得您的首批用户

这是提交您的产品以获取用户的网站列表。请访问
[Launch Your Product](https://github.com/6677-ai/aibesttop-AI-Directory/blob/main/Startup-Your-Product-List.md)

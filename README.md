# Open Source aibesttop AI Web UI

This is an open-source AI Tools Directory project from [aibesttop AI Tool Directory](https://aibesttop.com). Our goal is to make it
...
[Simplified Chinese](https://github.com/6677-ai/aibesttop-ai-webui/blob/main/README.zh-CN.md) | English

## Support aibesttop AI in Product Hunt

<a href="https://www.producthunt.com/posts/ai-tools-directory-by-aibesttop-ai?embed=true&utm_source=badge-featured&utm_medium=badge&utm_souce=badge-ai&#0045;tools&#0045;directory&#0045;by&#0045;aibesttop&#0045;ai" target="_blank"><img src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=464357&theme=light" alt="AI&#0032;Tools&#0032;Directory&#0032;by&#0032;aibesttop&#0032;AI - Open&#0045;source&#0032;AI&#0032;navigation&#0032;&#0038;&#0032;discovery&#0032;with&#0032;multi&#0045;language | Product Hunt" style="width: 250px; height: 54px;" width="250" height="54" /></a>

## Version 2.0.0 Update Notes

- AI site data is stored using a supabase database.
- It is connected to the aibesttop AI crawler project, supporting fully automatic submission and collection.
...
click to switch to the [version 1.0.0 branch](https://github.com/6677-ai/aibesttop-ai-webui/tree/v1.0.0).
...
![aibesttop-ai](./public/images/aibesttopai.zh-CN.png)

## Follow and Support Links

Please follow our Twitter: https://x.com/aibesttopai

If you find the project helpful, please consider buying me a coffee:

<a href="https://www.buymeacoffee.com/aibesttopai0o" target="_blank"><img src="https://cdn.buymeacoffee.com/buttons/default-orange.png" alt="Buy Me A Coffee" height="41" width="174"></a>

If you are interested in the project, please add my WeChat: helloleo2023, note: "aibesttop ai open source"

## Deployment Instructions

### Deploying aibesttop AI Crawler

See [aibesttop AI Crawler](https://github.com/6677-ai/aibesttop-ai-crawler) for details. After deployment, you can use the
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2F6677-ai%2Faibesttop-ai-webui.git&env=NEXT_PUBLIC_SITE_URL,GOOGLE_TRACKING_ID,GOOGLE_ADSENSE_URL,CONTACT_US_EMAIL,NEXT_PUBLIC_SUPABASE_URL,NEXT_PUBLIC_SUPABASE_ANON_KEY,CRAWLER_API,CRAWLER_API_KEY,CRON_AUTH_KEY,SUBMIT_AUTH_KEY&project-name=aibesttop-ai)
...
```sh
# Your domain
NEXT_PUBLIC_SITE_URL="https://aibesttop.com"
...
CONTACT_US_EMAIL="contact@aibesttop.com"
...
```sh
git clone https://github.com/6677-ai/aibesttop-ai-webui.git
```
...
You can get the 13000+ AIs from aibesttop AI collected from other AI Tools Directory in
[AI Source List](https://github.com/6677-ai/aibesttop-ai-webui/blob/main/ai_source_list)

## Wanna submit your website on aibesttop.com?

Open: [aibesttop AI](https://aibesttop.com)

### Wanna add you website to our `/startup` page?

- open an issue here: [aibesttop-AI-Directory](https://github.com/6677-ai/aibesttop-AI-Directory/issues)
- email us: contact@aibesttop.com

## Links to our products

### aibesttop-AI-Directory

The Collection for the AI tools all over the world. | Collect free ChatGPT mirrors, alternatives,prompt, other AI tools,
etc. For more, please visit: [aibesttop AI](https://aibesttop.com)
...
[StartUp Your Product List](https://github.com/6677-ai/aibesttop-AI-Directory/blob/main/Startup-Your-Product-List.md)
...
Promo Code for Discount: aibesttopAI
...
visit: [6677-ai/aibesttop-ai-crawler](https://github.com/6677-ai/aibesttop-ai-crawler)
